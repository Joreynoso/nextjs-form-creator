...
Clases utilitarias listas para usar en tus componentes. Elige la variante según el contexto.

### Modo claro

```css
/* En tu globals.css o archivo de estilos */
@layer components {

  /* Card base con gradiente sutil — uso general */
  .card-gradient {
    background: linear-gradient(
      135deg,
      oklch(1.0000 0.0000  0.00) 0%,
      oklch(0.9300 0.0250 55.00) 100%
    );
  }

  /* Card con gradiente cálido — destacada / featured */
  .card-gradient-warm {
    background: linear-gradient(
      135deg,
      oklch(0.9800 0.0100 60.00) 0%,
      oklch(0.8900 0.0450 52.00) 100%
    );
  }

  /* Card con gradiente primario — CTA o hero card */
  .card-gradient-primary {
    background: linear-gradient(
      135deg,
      oklch(0.6500 0.1000 55.00) 0%,
      oklch(0.5500 0.1100 47.00) 100%
    );
    color: oklch(0.9900 0.0050 60.00); /* text-primary-foreground */
  }
...
@layer components {
  ...
  .dark .card-gradient {
    background: linear-gradient(
      135deg,
      oklch(0.2100 0.0250 47.00) 0%,
      oklch(0.1800 0.0200 45.00) 100%
    );
  }

  .dark .card-gradient-warm {
    background: linear-gradient(
      135deg,
      oklch(0.2600 0.0350 46.00) 0%,
      oklch(0.3200 0.0450 47.00) 100%
    );
  }

  .dark .card-gradient-primary {
    background: linear-gradient(
      135deg,
      oklch(0.7000 0.0850 52.00) 0%,
      oklch(0.8200 0.0900 55.00) 100%
    );
    color: oklch(0.1800 0.0200 45.00); /* text-primary-foreground dark */
  }
...
```jsx
{/* Sutil — la más versátil */}
<div className="card-gradient rounded-lg border border-border p-6 shadow-sm">
  Contenido
</div>

{/* Cálida — para destacar secciones */}
<div className="card-gradient-warm rounded-lg border border-border p-6 shadow-sm">
  Contenido destacado
</div>

{/* Primaria — CTA, planes de precio, hero cards */}
<div className="card-gradient-primary rounded-lg p-6 shadow-md">
  Call to action
</div>
```

### Variante con Tailwind puro (sin clase personalizada)

Si prefieres no salir de Tailwind, puedes combinar estas clases utilitarias directamente:

```jsx
{/* Gradiente sutil */}
<div className="bg-gradient-to-br from-card to-secondary rounded-lg border border-border p-6">

{/* Gradiente cálido */}
<div className="bg-gradient-to-br from-background to-accent rounded-lg border border-border p-6">

{/* Gradiente primario */}
<div className="bg-gradient-to-br from-primary/80 to-primary rounded-lg p-6 text-primary-foreground">
```
